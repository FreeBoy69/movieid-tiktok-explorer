...
export const STUDIO_APPS: Record<StudioApp["id"], StudioApp> = {
  ...
  video: { id: "video", label: "Video Studio", icon: i(Film), summary: "Text to video, image to video, and video upscaling.", heading: "Make a video", body: "Describe a shot to generate it from text. Models that take images add Start frame and Start + end modes to the prompt bar. Sharpen a clip in Upscale.", action: "Generate video", placeholder: "Describe the shot, subject, and camera movement" },
