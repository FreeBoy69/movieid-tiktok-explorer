...
export const STUDIO_APPS: Record<StudioApp["id"], StudioApp> = {
  ...
  video: { id: "video", label: "Video Studio", icon: i(Film), summary: "Text to video, image to video, and video upscaling.", heading: "Make a video", body: "Write a prompt for text-to-video, or add a first frame (and a last frame on models that support it) to animate an image. Switch to Upscale to sharpen a clip.", action: "Generate video", placeholder: "Describe the shot, subject, and camera movement" },
