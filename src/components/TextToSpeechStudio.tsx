...
export function TextToSpeechStudio({ theme = "light", initialText = "" }: { theme?: "light" | "dark"; initialText?: string }) {
  ...
  return (
    <section className={cn("flex h-full min-h-0 flex-col overflow-hidden", dark ? "bg-[#0B0E14] text-white" : "bg-white text-[#111827]")}>
      <header className={cn("flex min-h-12 flex-col gap-3 border-b px-4 py-3 sm:flex-row sm:items-center sm:justify-between", dark ? "border-white/10" : "border-[#E5E7EB]")}>
