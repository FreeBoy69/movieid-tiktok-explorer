...
async function prepareShortsUploadFile(inputPath, settings = {}, context = {}) {
    ...
    return {
        ...
        metrics: {
            ...
            transcriptError,
            transcriptScored: choice.transcriptScored === true,
            transcriptDecision: choice.decision || null,
            transcriptAlternatives: Array.isArray(choice.alternatives) ? choice.alternatives : [],
