...
def _video_to_row(v) -> dict | None:
    ...
    return {
        ...
        "author": nickname,
        "authorAvatar": (raw_author.get("avatarMedium") or raw_author.get("avatarThumb") or raw_author.get("avatarLarger") or "") if isinstance(raw_author, dict) else "",
        "authorHandle": handle,
...
def _tikwm_video_to_row(item: dict) -> dict | None:
    ...
    return {
        ...
        "authorAvatar": str(author.get("avatar") or ""),
